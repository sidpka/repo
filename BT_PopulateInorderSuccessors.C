...
void SetInorderSuccessor(struct TNode* root){
...
printf("\nDone\n");
getch();
printf("Node : %d   Successor : %d",root->data,root->next->data);
printf("Node : %d   Successor : %d",root->left->data,root->left->next->data);
//printf("Node : %d   Successor : %d",root->right->data,root->right->next->data);
printf("Node : %d   Successor : %d",root->left->left->data,root->left->left->next->data);

printf("Node : %d   Successor : %d",root->left->right->data,root->left->right->next->data);
