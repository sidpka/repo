...
void DijkastraUtil(GNode* graph,int* distance,int sourceNode,int E){
...
newDistance=distance[u]+tmpLink->wait;
if(distance[u]!=INT_MAX && newDistance< distance[v]){
...
void DijkastraFinder(GNode* graph,int sourceNode,int E){
...
//printf("\nHere 295\n");
DijkastraUtil(graph,distance,sourceNode,E);
//printf("\nHere 297\n");
}
...
DijkastraFinder(graph,sourceNode,E);
getch();
