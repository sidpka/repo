...
struct TNode* FindSuccessor(struct TNode* root,struct TNode* tmpNode){
SNode* stack=Populate();
...
getch();
*/
printf("\nPress enter to do Pre-Order traversal : \n\n");
getch();
PreOrderTraversal(root,n);
getch();

printf("\nPress enter to do In-Order traversal : \n\n");
getch();
InOrderTraversal(root);
/*
printf("\nPress enter to do Post-Order traversal : \n\n");
getch();
PostOrderTraversal(root);
*/
getch();
struct TNode* tmpNode=root->left->right;
printf("\nFind successor of : %d",tmpNode->data);
tmpNode=FindSuccessor(root,tmpNode);
printf("\nSuccessor is : %d",tmpNode->data);
getch();
return 0;
}
